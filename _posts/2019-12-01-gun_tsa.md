...
One of the main goals of this project was to determine if a relationship exists between firearm deaths and gun sales.  After careful examination we were able to develop a linear model, $Y_t = 0.0001x_t + \epsilon_t, \epsilon_t ~ WN(0, \sigma^2)$, shows there is indeed a positive relationship between firearm deaths and gun sales.
