...
One of the main goals of this project was to determine if a relationship exists between firearm deaths and gun sales.  After careful examination we were able to develop a linear model, Yt = 0.001xt + t , t ~ WN(0, 2), shows there is indeed a positive relationship between firearm deaths and gun sales.
